...
public class ScoreController {
    ...
    public String jsonList(@RequestBody Map<String, Object> param, @PathVariable String imageName, @PathVariable Long literatureId, @PathVariable String fontPath){
        ...
        */
        ...
        ArrayList<ArrayList<ArrayList<Integer>>> userLineZeroJamoList = gson.fromJson(userLineZeroJamo, (new TypeToken<ArrayList<ArrayList<ArrayList<Integer>>>>(){ }).getType()); //0번째 줄의 음소 정보 배열
        ...
        ArrayList<ArrayList<ArrayList<Integer>>> userLineOneJamoList = gson.fromJson(userLineOneJamo, (new TypeToken<ArrayList<ArrayList<ArrayList<Integer>>>>(){ }).getType()); //1번째 줄의 음소 정보 배열
        ...
        ArrayList<ArrayList<ArrayList<Integer>>> userLineTwoJamoList = gson.fromJson(userLineTwoJamo, (new TypeToken<ArrayList<ArrayList<ArrayList<Integer>>>>(){ }).getType()); //2번째 줄의 음소 정보 배열
        ...
        ArrayList<ArrayList<ArrayList<Integer>>> userLineThreeJamoList = gson.fromJson(userLineThreeJamo, (new TypeToken<ArrayList<ArrayList<ArrayList<Integer>>>>(){ }).getType()); //3번째 줄의 음소 정보 배열
        ...
        List<List<List<Integer>>> textBookLineZeroJamoList = gson.fromJson(textBookLineZeroJamo, (new TypeToken<List<List<List<Integer>>>>(){ }).getType()); //0번째 줄의 음소 정보 배열
        ...
        List<List<List<Integer>>> textBookLineOneJamoList = gson.fromJson(textBookLineOneJamo, (new TypeToken<List<List<List<Integer>>>>(){ }).getType()); //1번째 줄의 음소 정보 배열
        ...
        List<List<List<Integer>>> textBookLineTwoJamoList = gson.fromJson(textBookLineTwoJamo, (new TypeToken<List<List<List<Integer>>>>(){ }).getType()); //2번째 줄의 음소 정보 배열
        ...
        List<List<List<Integer>>> textBookLineThreeJamoList = gson.fromJson(textBookLineThreeJamo, (new TypeToken<List<List<List<Integer>>>>(){ }).getType()); //3번째 줄의 음소 정보 배열
